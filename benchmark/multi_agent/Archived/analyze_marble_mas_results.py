"""
MARBLE MAS (Multi-Agent Serving) Experiments - Results Analyzer

This script analyzes the results from run_marble_mas_experiments.py
and generates:
...
Usage:
    python analyze_marble_mas_results.py --input-root ./results/20260202_123456_marble_mas
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Analyze MARBLE MAS (Multi-Agent Serving) Experiment Results"
    )
    parser.add_argument(
        "--input-root",
        type=Path,
    ...
    report_lines.append("# MARBLE MAS (Multi-Agent Serving) Experiments - Results\n")
