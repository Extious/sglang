"""
MARBLE MAS (Multi-Agent Serving) Experiments Runner
...
3. Experiment 3: MAS (criticality) scheduling

Usage:
    python run_marble_mas_experiments.py --model-path Qwen/Qwen3-4B-Thinking-2507
...
def _default_output_root() -> Path:
    ...
    return _script_dir() / "results" / f"{ts}_marble_mas"
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Run MARBLE MAS (Multi-Agent Serving) Experiments",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
    # Run with default settings
    python run_marble_mas_experiments.py

    # Specify model path
    python run_marble_mas_experiments.py --model-path Qwen/Qwen3-4B-Thinking-2507

    # Custom output directory
    python run_marble_mas_experiments.py --output-root ./my_results
...
Environment Variables:
    ...
    marble_dir = _script_dir().parent / "dataset" / "MARBLE"
    ...
    print("="*60)
    print("MARBLE MAS (Multi-Agent Serving) Experiments")
    print("="*60)
    ...
    if not args.skip_exp3:
        ...
        if exp3_existing < exp3_expected:
            print("\n" + "="*60)
            print("Experiment 3: MAS Scheduling")
