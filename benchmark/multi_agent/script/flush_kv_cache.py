"""
CLI script to flush KV cache on SGLang workers.

Usage:
    python script/flush_kv_cache.py --worker-urls-file logs/worker_urls.txt
    python script/flush_kv_cache.py --worker-urls http://gpu18:8000 http://gpu19:8000
"""
