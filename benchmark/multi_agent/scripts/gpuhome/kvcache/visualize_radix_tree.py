...
Usage:
    python script/kvcache/visualize_radix_tree.py --worker-urls-file logs/worker_urls.txt
    python script/kvcache/visualize_radix_tree.py --worker-urls http://gpu18:8000 http://gpu19:8000
    python script/kvcache/visualize_radix_tree.py --worker-urls-file logs/worker_urls.txt --strategy my_exp --max-nodes 500
"""
